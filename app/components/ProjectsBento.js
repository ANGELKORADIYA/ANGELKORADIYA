...
export const projects = [
  {
    ...
    category: 'RAG & GenAI',
    tech: 'TypeScript, FastAPI, React, Qdrant, PostgreSQL',
    tags: ['TypeScript', 'FastAPI', 'Qdrant', 'RAG', 'PostgreSQL'],
    status: 'Production-Ready',
    priority: 15,
    goal: 'Democratize enterprise database access by allowing non-technical users to query complex relational schemas securely using natural language.',
    built: 'A sophisticated RAG pipeline with AST-based scope validation (SQLGlot), automated training pair synthesis, and dual-layer RBAC.',
    marketContext: 'Enterprise database querying with strict data governance and row/column security.',
    future: 'Autonomous data-cleaning sub-agents and multi-modal query execution.'
  },
  {
    id: 1002,
    title: 'IndexForge',
    description: 'High-performance local-first hybrid search engine in Rust combining BM25 keyword matching, trigram fuzzy search, and HNSW semantic vector retrieval with Reciprocal Rank Fusion (RRF, k=60) and sub-10ms p50 latency.',
    link: 'https://github.com/ANGELKORADIYA/IndexForge',
    link2: 'https://github.com/ANGELKORADIYA/IndexForge',
    category: 'Systems & Search',
    tech: 'Rust, Axum, Tantivy, pgvector, Tree-sitter',
    tags: ['Rust', 'Axum', 'Tantivy', 'pgvector', 'Tree-sitter'],
    status: 'Production-Ready',
    priority: 14,
    goal: 'A local-first search engine that fuses keyword exactness, fuzzy tolerance, and vector semantics entirely offline.',
    built: 'A 9-crate compiled Rust engine with 3 parallel search arms, RRF merging, cross-encoders, and language-aware AST code chunking via Tree-sitter.',
    marketContext: '100% offline, privacy-first semantic code and document search without cloud dependencies.',
    future: 'Distributed sharded indexing and cross-platform desktop sidecars.'
  },
  {
    id: 2,
    title: 'ForgeOAgent',
    description: 'Autonomous multi-agent framework featuring dynamic AST-based Python tool reflection, runtime pip dependency auto-resolution, and isolated sandboxed execution with sub-2s reasoning cycles.',
    ...
    tech: 'Python, FastAPI, Gemini API, wxPython, LangGraph',
    tags: ['Python', 'FastAPI', 'AI Agents', 'AST', 'LangGraph'],
    status: 'Active',
    priority: 13,
    goal: 'Autonomous goal decomposition and multi-agent coordination with runtime self-healing and tool discovery.',
    built: 'A four-interface suite (PyPI, CLI, desktop GUI, web API) with an autonomous orchestrator coordinating specialized sub-agents.',
    marketContext: 'Reliable, transparent agent orchestration in local and cloud environments.',
    future: 'MCP protocol server integration and distributed worker pools.'
  },
  {
    id: 1001,
    title: 'Aerobatch',
    description: 'On-premises intelligent document processing pipeline processing 100+ page specifications at 2 pages/min on CPU using PaddleOCR, Celery, FastAPI, and vLLM with confidence fusion.',
    link: '',
    link2: '',
    category: 'Document AI',
    tech: 'Python, PaddleOCR, vLLM, Celery, FastAPI',
    tags: ['Python', 'OCR', 'vLLM', 'FastAPI', 'Celery'],
    status: 'Production-Ready',
    priority: 12,
    goal: 'High-concurrency extraction of structured data and form fields from complex documents under strict air-gapped CPU constraints.',
    built: 'A streaming ingestion pipeline, bidirectional canvas hit-testing viewer, and defensive Confidence Fusion Service eliminating hallucinations.',
    marketContext: 'Enterprise document extraction with zero external cloud dependencies.',
    future: 'Dynamic schema evolution across multi-lingual document sets.'
  },
  {
    id: 1003,
    title: 'Reel Mind',
